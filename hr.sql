...
select First_Name from employees where ROW(DEPARTMENT_ID,MANAGER_ID)=(select DEPARTMENT_ID,MANAGER_ID from departments where LOCATION_ID = 2400);

select DEPARTMENT_ID,MANAGER_ID from departments where LOCATION_ID = 2400;
select  * from employees where DEPARTMENT_ID=40 and MANAGER_ID=203;

select EMPLOYEE_ID,FIRST_NAME,LAST_NAME,JOB_ID,DEPARTMENT_ID from employees where exists (select*from employees where MANAGER_ID =EMPLOYEE_ID );

select DEPARTMENT_ID,DEPARTMENT_NAME from departments where not exists (select*from employees where DEPARTMENT_ID = DEPARTMENT_ID);

select contact,subquery1 from contacts,(select site,sum,astotal from pages group by site_name)subquery where subquery = contact_name;

select LAST_NAME,SALARY,DEPARTMENT_ID from employees where SALARY > (select avg(SALARY) from employees where DEPARTMENT_ID=DEPARTMENT_ID);

select EMPLOYEE_ID,FIRST_NAME,LAST_NAME ,JOB_ID from employees where 1 <=(select count(*)from job_history where EMPLOYEE_ID = EMPLOYEE_ID); 

select departments.DEPARTMENT_ID , departments.MANAGER_ID, employees.EMPLOYEE_ID from  departments inner join employees on departments.DEPARTMENT_ID = employees.DEPARTMENT_ID;


select departments.DEPARTMENT_ID , departments.MANAGER_ID, employees.EMPLOYEE_ID from  departments right  join employees on departments.DEPARTMENT_ID = employees.DEPARTMENT_ID;
select departments.DEPARTMENT_ID , departments.MANAGER_ID, employees.EMPLOYEE_ID from  departments left  join employees on departments.DEPARTMENT_ID = employees.DEPARTMENT_ID;

select departments.DEPARTMENT_ID , departments.MANAGER_ID, employees.EMPLOYEE_ID from  departments right outer join employees on departments.DEPARTMENT_ID = employees.DEPARTMENT_ID;
select departments.DEPARTMENT_ID , departments.MANAGER_ID, employees.EMPLOYEE_ID from  departments left outer join employees on departments.DEPARTMENT_ID = employees.DEPARTMENT_ID;


select DEPARTMENT_ID ,MANAGER_ID from employees union select DEPARTMENT_ID ,Job_ID from job_history ;

select DEPARTMENT_ID ,MANAGER_ID from employees union all select DEPARTMENT_ID ,Job_ID from job_history ;
